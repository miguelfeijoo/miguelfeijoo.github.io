function first(){
				...
				data = d3.merge(await Promise.all(["df_homicidios_total",'df_amenazas_total','df_delSexuales_total'].map(name => d3.csv(`https://raw.githubusercontent.com/miguelfeijoo/miguelfeijoo.github.io/master/Delitos2018/data/processed/${name}.csv`, d => {
