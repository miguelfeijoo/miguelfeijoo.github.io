...
! function(t, e, i) {
    var n = t.L,
        o = {};
    o.version = "0.6.3", "object" == typeof module && "object" == typeof module.exports ? module.exports = o : "function" == typeof define && define.amd && define(o), o.noConflict = function() {
            return t.L = n, this
        }, t.L = o, o.Util = {
            extend: function(t) {
    ...
    o.Mixin = {}, o.Mixin.Events = {
        ...
        function() {
            ...
            getMinZoom: function() {
                var t = this._layersMinZoom === i ? -1 / 0 : this._layersMinZoom,
                    e = this._boundsMinZoom === i ? -1 / 0 : this._boundsMinZoom;
